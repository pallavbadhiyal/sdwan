...
print(mydata["Metadata"]['AWS::CloudFormation::Interface']["ParameterGroups"].keys())

# if mydata["Metadata"]['AWS::CloudFormation::Interface']["ParameterGroups"][1]["Label"]["default"] == "Amazon EC2 Configuration":
